...
const translations = {
  pt: {
    pageTitle: "ALFA Tech Softwares | Produto Digital, Sistemas e Automação Sob Medida",
    pageDescription:
      "ALFA Tech Softwares projeta sites, plataformas, apps, automações e integrações com foco em performance, acessibilidade, documentação e escala.",
    brandName: "ALFA Tech Softwares",
    ...
    aboutEyebrow: "ALFA Tech Softwares",
    ...
    briefCompanyPlaceholder: "Ex.: ALFA Tech Softwares",
    ...
    briefMessageIntro:
      "Olá, quero solicitar uma análise e um orçamento com a ALFA Tech Softwares. Segue um briefing inicial do projeto:",
    ...
    quoteMessage:
      "Olá, quero solicitar uma análise inicial e um orçamento para um projeto com a ALFA Tech Softwares.",
    serviceQuoteMessage:
  ...
  en: {
    pageTitle: "ALFA Tech Softwares | Digital Products, Systems, and Automation",
    pageDescription:
      "ALFA Tech Softwares designs websites, platforms, apps, automations, and integrations with focus on performance, accessibility, documentation, and scale.",
    brandName: "ALFA Tech Softwares",
    ...
    briefMessageIntro:
      "Hello, I would like to request an initial assessment and a quote from ALFA Tech Softwares. Here is a first project brief:",
    ...
    floatingWhatsApp: "WhatsApp",
    quoteMessage:
      "Hello, I would like to request an initial assessment and a quote for a project with ALFA Tech Softwares.",
    serviceQuoteMessage:
